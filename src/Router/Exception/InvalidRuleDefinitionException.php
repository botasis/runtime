 ...
 * @internal
 */
final class InvalidRuleDefinitionException extends InvalidArgumentException implements FriendlyExceptionInterface
{
    ...
    public function __construct(?Throwable $previous, string ...$routeKeys)
    {
        ...
        $message = "Invalid rule definition in route $this->routePath";
    ...
    {
        return 'Invalid Route Rule Definition';
    }
